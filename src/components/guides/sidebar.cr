  ...
  def render
    div class: "text-black absolute pin-t pin-l bg-white rounded-lg shadow-lg w-sidebar mt-5 ml-2 pb-3 mb-10" do
      ul class: "list-reset" do
        ...
        link "Test article", "#", class: "uppercase block text-sm tracking-wide text-grey-darker no-underline pl-8 py-3 hover:bg-grey-lighter hover:underline #{active_class}"
        10.times do
          li do
            link "Test article", "#", class: "uppercase block text-sm tracking-wide text-grey-darker no-underline pl-8 py-3 hover:bg-grey-lighter hover:underline hover:text-blue-dark"
          end
        end
      end
    end
