class Learn::IndexPage < PageLayout
  ...
  def content
    div class: "max-w-7xl mx-auto md:-mt-12 md:rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px" do
      render_guides_card
      render_tutorial_card
      render_screencasts_card
      render_awesome_lucky_card
      render_ecosystem_card
      render_community_card
    end
  end

  private def render_hero_content
    div class: "bg-lucky-teal-blue-gradient" do
      div class: "py-8 md:pt-16 md:pb-28 px-6 sm:px-10 mx-auto container text-center text-white" do
  ...
  private def render_guides_card
    div class: "sm:rounded-tl-lg relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500" do
      div do
      ...
      render_fixed_top_right_arrow
    end
  end

  private def render_tutorial_card
  ...
  private def render_screencasts_card
  ...
  private def render_awesome_lucky_card
    div class: "relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500" do
      div do
  ...
  private def render_ecosystem_card
  ...
  private def render_community_card
    div class: "sm:rounded-br-lg relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500" do
      div do
  ...
  private def render_document_icon
  ...
  private def render_fixed_top_right_arrow
  ...
  private def render_academic_cap_icon
    tag "svg", class: "h-6 w-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" do
