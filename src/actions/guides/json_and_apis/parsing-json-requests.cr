class Guides::JsonAndApis::ParsingJsonRequests < GuideAction
  ...
  def markdown : String
    ...
    You can use
    [`JSON.mapping`](https://crystal-lang.org/api/JSON.html#mapping%28_properties_%2Cstrict%3Dfalse%29-macro)
    and [`JSON.parse`](https://crystal-lang.org/api/JSON.html) to parse
