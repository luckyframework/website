class Guides::Database::Models < GuideAction
  ...
  def markdown : String
    ...
    * `updated_at` - default `Time` type.
    ...
    If you remove timestamps from these default columns and you still want the automatic default behavior, you'll need to:

    - Add created_at and/or updated_at columns to specific models
    - Make sure they are annotated with `autogenerated: true`
